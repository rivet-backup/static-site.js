...
export var serializeAws_restJson1GetSuggestedBlogsCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                _a = _c.sent(), hostname = _a.hostname, _b = _a.protocol, protocol = _b === void 0 ? "https" : _b, port = _a.port, basePath = _a.path;
                headers = {};
                resolvedPath = "".concat((basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')) + "/blogs";
                query = __assign(__assign({}, (input.count !== undefined && { "count": input.count.toString() })), (input.watchIndex !== undefined && { "watch_index": input.watchIndex }));
                return [2, new __HttpRequest({
                        protocol: protocol,
                        hostname: hostname,
                        port: port,
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                body = JSON.stringify(__assign({}, (input.firebase !== undefined && input.firebase !== null && { "firebase": serializeAws_restJson1Firebase(input.firebase, context) })));
                return [2, new __HttpRequest({
                        protocol: protocol,
                        hostname: hostname,
                        port: port,
...
export var deserializeAws_restJson1GetSuggestedBlogsCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents, data, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1GetSuggestedBlogsCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                    blogs: undefined,
            ...
            case 1:
                data = _a.apply(void 0, [(_b.apply(void 0, [_c.sent()])), "body"]);
                if (data.blogs !== undefined && data.blogs !== null) {
                    contents.blogs = deserializeAws_restJson1BlogPostSummaries(data.blogs, context);
                }
                if (data.watch !== undefined && data.watch !== null) {
                    contents.watch = deserializeAws_restJson1WatchResponse(data.watch, context);
                }
...
var deserializeAws_restJson1GetSuggestedBlogsCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
...
var serializeAws_restJson1Firebase = function (input, context) {
    return __assign({}, (input.accessKey !== undefined && input.accessKey !== null && { "access_key": input.accessKey }));
};
var deserializeAws_restJson1BlogPostSummaries = function (output, context) {
    var retVal = (output || []).filter(function (e) { return e != null; }).map(function (entry) {
        if (entry === null) {
            return null;
        }
        return deserializeAws_restJson1BlogPostSummary(entry, context);
    });
    return retVal;
};
var deserializeAws_restJson1BlogPostSummary = function (output, context) {
    return {
        author: __expectString(output.author),
        categories: (output.categories !== undefined && output.categories !== null) ? deserializeAws_restJson1Categories(output.categories, context) : undefined,
        imageUrl: __expectString(output.image_url),
...
var deserializeAws_restJson1GameProfile = function (output, context) {
    return {
        ...
        isStarred: __expectBoolean(output.is_starred),
        ...
        starCount: __expectInt32(output.star_count),
