...
import { GetSuggestedBlogsCommand, } from "./commands/GetSuggestedBlogsCommand";
...
var PortalService = (function (_super) {
    ...
    PortalService.prototype.getSuggestedBlogs = function (args, optionsOrCb, cb) {
        var command = new GetSuggestedBlogsCommand(args);
        if (typeof optionsOrCb === "function") {
            this.send(command, optionsOrCb);
        }
        else if (typeof cb === "function") {
