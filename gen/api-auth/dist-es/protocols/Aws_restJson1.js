...
export var serializeAws_restJson1GetIdentityTokenCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, hostname, _b, protocol, port, basePath, headers, resolvedPath, body;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, context.endpoint()];
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                body = JSON.stringify(__assign({}, (input.email !== undefined && input.email !== null && { "email": input.email })));
                return [2, new __HttpRequest({
                        protocol: protocol,
                        hostname: hostname,
                        port: port,
...
export var deserializeAws_restJson1GetIdentityTokenCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents, data, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1GetIdentityTokenCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                    exp: undefined,
            ...
            case 1:
                ...
                if (data.exp !== undefined && data.exp !== null) {
                    contents.exp = __expectLong(data.exp);
                }
...
var deserializeAws_restJson1GetIdentityTokenCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
