...
import { GetIdentityTokenCommand, } from "./commands/GetIdentityTokenCommand";
...
var AuthService = (function (_super) {
    ...
    AuthService.prototype.getIdentityToken = function (args, optionsOrCb, cb) {
        var command = new GetIdentityTokenCommand(args);
        if (typeof optionsOrCb === "function") {
            this.send(command, optionsOrCb);
        }
        else if (typeof cb === "function") {
