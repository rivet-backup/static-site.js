...
import { BadRequestError, ChatTypingStatus, ForbiddenError, InternalError, NotFoundError, RateLimitError, SendMessageBody, UnauthorizedError, } from "../models/models_0";
import { HttpRequest as __HttpRequest, } from "@aws-sdk/protocol-http";
import { decorateServiceException as __decorateServiceException, expectBoolean as __expectBoolean, expectInt32 as __expectInt32, expectLong as __expectLong, expectNonNull as __expectNonNull, expectObject as __expectObject, expectString as __expectString, expectUnion as __expectUnion, extendedEncodeURIComponent as __extendedEncodeURIComponent, } from "@aws-sdk/smithy-client";
export var serializeAws_restJson1GetIdentityDirectChatCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                headers = {};
                resolvedPath = "".concat((basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')) + "/identities/{identity_id}/chat";
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                query = __assign(__assign(__assign({}, (input.ts !== undefined && { "ts": input.ts.toString() })), (input.count !== undefined && { "count": input.count.toString() })), (input.queryDirection !== undefined && { "query_direction": input.queryDirection }));
                return [2, new __HttpRequest({
                        protocol: protocol,
                        hostname: hostname,
                        port: port,
...
export var serializeAws_restJson1GetThreadLiveCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, hostname, _b, protocol, port, basePath, headers, resolvedPath, labelValue, query, body;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, context.endpoint()];
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                resolvedPath = "".concat((basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')) + "/threads/{thread_id}/message";
                if (input.threadId !== undefined) {
                    labelValue = input.threadId;
                    if (labelValue.length <= 0) {
                        throw new Error('Empty value provided for input HTTP label: threadId.');
                ...
                body = JSON.stringify(__assign({}, (input.messageBody !== undefined && input.messageBody !== null && { "message_body": serializeAws_restJson1SendMessageBody(input.messageBody, context) })));
                return [2, new __HttpRequest({
                        protocol: protocol,
                        hostname: hostname,
                        port: port,
...
export var serializeAws_restJson1SendChatMessageWithTopicCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                resolvedPath = "".concat((basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')) + "/chat/message-with-topic";
                query = __assign(__assign(__assign({}, (input.identityId !== undefined && { "identity_id": input.identityId })), (input.groupId !== undefined && { "group_id": input.groupId })), (input.partyId !== undefined && { "party_id": input.partyId }));
                body = JSON.stringify(__assign({}, (input.messageBody !== undefined && input.messageBody !== null && { "message_body": serializeAws_restJson1SendMessageBody(input.messageBody, context) })));
                return [2, new __HttpRequest({
                        protocol: protocol,
                        hostname: hostname,
...
export var serializeAws_restJson1UpdateThreadReadCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, hostname, _b, protocol, port, basePath, headers, resolvedPath, labelValue, body;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, context.endpoint()];
            case 1:
                ...
                body = JSON.stringify(__assign({}, (input.lastReadTs !== undefined && input.lastReadTs !== null && { "last_read_ts": input.lastReadTs })));
                return [2, new __HttpRequest({
                        protocol: protocol,
                        hostname: hostname,
                        port: port,
...
export var serializeAws_restJson1UpdateTypingStatusCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, hostname, _b, protocol, port, basePath, headers, resolvedPath, labelValue, body;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, context.endpoint()];
...
export var deserializeAws_restJson1GetIdentityDirectChatCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents, data, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1GetIdentityDirectChatCommandError(output, context)];
                }
                contents = {
...
var deserializeAws_restJson1GetIdentityDirectChatCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
...
export var deserializeAws_restJson1GetThreadLiveCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents, data, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1GetThreadLiveCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                    chatMessages: undefined,
...
var deserializeAws_restJson1GetThreadLiveCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
        ...
        switch (_c.label) {
            ...
            case 1:
                ...
                if (data.topic !== undefined && data.topic !== null) {
                    contents.topic = deserializeAws_restJson1ChatSimpleTopicContext(__expectUnion(data.topic), context);
                }
                return [2, Promise.resolve(contents)];
        }
    });
...
export var deserializeAws_restJson1SendChatMessageWithTopicCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents, data, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1SendChatMessageWithTopicCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                    chatMessageId: undefined,
...
var deserializeAws_restJson1SendChatMessageWithTopicCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
...
export var deserializeAws_restJson1UpdateThreadReadCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1UpdateThreadReadCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                };
...
var deserializeAws_restJson1UpdateThreadReadCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
...
export var deserializeAws_restJson1UpdateTypingStatusCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1UpdateTypingStatusCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                };
...
var deserializeAws_restJson1UpdateTypingStatusCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
...
var deserializeAws_restJson1ChatSimpleTopicContext = function (output, context) {
    if (output.direct !== undefined && output.direct !== null) {
        return {
            direct: deserializeAws_restJson1ChatSimpleTopicDirectContext(output.direct, context)
        };
    }
    if (output.group !== undefined && output.group !== null) {
        return {
            group: deserializeAws_restJson1ChatSimpleTopicGroupContext(output.group, context)
        };
    }
    if (output.party !== undefined && output.party !== null) {
        return {
            party: deserializeAws_restJson1ChatSimpleTopicPartyContext(output.party, context)
        };
    }
    return { $unknown: Object.entries(output)[0] };
};
var deserializeAws_restJson1ChatSimpleTopicDirectContext = function (output, context) {
    return {
        identityAId: __expectString(output.identity_a_id),
        identityBId: __expectString(output.identity_b_id),
    };
};
var deserializeAws_restJson1ChatSimpleTopicGroupContext = function (output, context) {
    return {
        groupId: __expectString(output.group_id),
    };
};
var deserializeAws_restJson1ChatSimpleTopicPartyContext = function (output, context) {
    return {
