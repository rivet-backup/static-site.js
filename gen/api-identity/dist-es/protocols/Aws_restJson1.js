...
export var serializeAws_restJson1AddFriendCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                headers = {};
                resolvedPath = "".concat((basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')) + "/identities/{identity_id}/friend";
...
export var serializeAws_restJson1GameIdentityLinkCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                resolvedPath = "".concat((basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')) + "/links/game-identity";
...
export var serializeAws_restJson1GameIdentityLinkCompleteCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, hostname, _b, protocol, port, basePath, headers, resolvedPath, body;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, context.endpoint()];
            case 1:
                ...
                resolvedPath = "".concat((basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')) + "/links/game-identity/complete";
                body = JSON.stringify(__assign({}, (input.identityLinkToken !== undefined && input.identityLinkToken !== null && { "identity_link_token": input.identityLinkToken })));
                return [2, new __HttpRequest({
                        protocol: protocol,
                        hostname: hostname,
...
export var serializeAws_restJson1GetActivitiesCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
...
export var serializeAws_restJson1GetEventsCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, hostname, _b, protocol, port, basePath, headers, resolvedPath, query, body;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, context.endpoint()];
...
export var serializeAws_restJson1GetIdentityGameLinkStatusCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, hostname, _b, protocol, port, basePath, headers, resolvedPath, labelValue, body;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, context.endpoint()];
            case 1:
                _a = _c.sent(), hostname = _a.hostname, _b = _a.protocol, protocol = _b === void 0 ? "https" : _b, port = _a.port, basePath = _a.path;
                headers = {};
                resolvedPath = "".concat((basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')) + "/identities/links/{link_id}";
                if (input.linkId !== undefined) {
                    labelValue = input.linkId;
                    if (labelValue.length <= 0) {
                        throw new Error('Empty value provided for input HTTP label: linkId.');
                    }
                    resolvedPath = resolvedPath.replace("{link_id}", __extendedEncodeURIComponent(labelValue));
                }
                else {
...
export var serializeAws_restJson1GetIdentitySelfCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, hostname, _b, protocol, port, basePath, headers, resolvedPath, body;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, context.endpoint()];
...
export var serializeAws_restJson1IdentityAvatarUploadCompleteCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, hostname, _b, protocol, port, basePath, headers, resolvedPath, labelValue, body;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, context.endpoint()];
...
export var serializeAws_restJson1IdentityAvatarUploadPrepareCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, hostname, _b, protocol, port, basePath, headers, resolvedPath, body;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, context.endpoint()];
...
export var serializeAws_restJson1RemoveFriendCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, hostname, _b, protocol, port, basePath, headers, resolvedPath, labelValue, body;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, context.endpoint()];
...
export var serializeAws_restJson1RequestIdentityGameLinkCommand = function (input, context) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, hostname, _b, protocol, port, basePath, headers, resolvedPath, body;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4, context.endpoint()];
            case 1:
                ...
                resolvedPath = "".concat((basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')) + "/identities/links";
                body = "";
                return [2, new __HttpRequest({
                        protocol: protocol,
                        hostname: hostname,
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                body = JSON.stringify(__assign({}, (input.identityToken !== undefined && input.identityToken !== null && { "identity_token": input.identityToken })));
                return [2, new __HttpRequest({
                        protocol: protocol,
                        hostname: hostname,
                        port: port,
...
export var deserializeAws_restJson1AddFriendCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1AddFriendCommandError(output, context)];
                }
                contents = {
...
var deserializeAws_restJson1AddFriendCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
...
export var deserializeAws_restJson1GameIdentityLinkCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents, data, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1GameIdentityLinkCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                    game: undefined,
            ...
            case 1:
                ...
                if (data.link_id !== undefined && data.link_id !== null) {
                    contents.linkId = __expectString(data.link_id);
                }
                return [2, Promise.resolve(contents)];
        }
    });
}); };
var deserializeAws_restJson1GameIdentityLinkCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
...
export var deserializeAws_restJson1GameIdentityLinkCompleteCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents, data, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1GameIdentityLinkCompleteCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                    valid: undefined,
...
var deserializeAws_restJson1GameIdentityLinkCompleteCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
...
export var deserializeAws_restJson1GetActivitiesCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents, data, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1GetActivitiesCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
...
var deserializeAws_restJson1GetActivitiesCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
...
export var deserializeAws_restJson1GetEventsCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents, data, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1GetEventsCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                    events: undefined,
            ...
            case 1:
                ...
                if (data.refreshed !== undefined && data.refreshed !== null) {
                    contents.refreshed = __expectBoolean(data.refreshed);
                }
                if (data.watch !== undefined && data.watch !== null) {
                    contents.watch = deserializeAws_restJson1WatchResponse(data.watch, context);
                }
...
var deserializeAws_restJson1GetEventsCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
...
export var deserializeAws_restJson1GetIdentityGameLinkStatusCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents, data, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1GetIdentityGameLinkStatusCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                    status: undefined,
...
var deserializeAws_restJson1GetIdentityGameLinkStatusCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
...
export var deserializeAws_restJson1GetIdentitySelfCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents, data, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1GetIdentitySelfCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                    identity: undefined,
...
var deserializeAws_restJson1GetIdentitySelfCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
...
export var deserializeAws_restJson1IdentityAvatarUploadCompleteCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1IdentityAvatarUploadCompleteCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                };
...
var deserializeAws_restJson1IdentityAvatarUploadCompleteCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
...
export var deserializeAws_restJson1IdentityAvatarUploadPrepareCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents, data, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1IdentityAvatarUploadPrepareCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
...
var deserializeAws_restJson1IdentityAvatarUploadPrepareCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
...
export var deserializeAws_restJson1RemoveFriendCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1RemoveFriendCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                };
...
var deserializeAws_restJson1RemoveFriendCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
...
export var deserializeAws_restJson1RequestIdentityGameLinkCommand = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var contents, data, _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                if (output.statusCode !== 200 && output.statusCode >= 300) {
                    return [2, deserializeAws_restJson1RequestIdentityGameLinkCommandError(output, context)];
                }
                contents = {
                    $metadata: deserializeMetadata(output),
                    expireTs: undefined,
            ...
            case 1:
                ...
                if (data.expire_ts !== undefined && data.expire_ts !== null) {
                    contents.expireTs = __expectLong(data.expire_ts);
                }
                if (data.link_id !== undefined && data.link_id !== null) {
                    contents.linkId = __expectString(data.link_id);
                }
                if (data.link_url !== undefined && data.link_url !== null) {
                    contents.linkUrl = __expectString(data.link_url);
                }
                return [2, Promise.resolve(contents)];
        }
    });
}); };
var deserializeAws_restJson1RequestIdentityGameLinkCommandError = function (output, context) { return __awaiter(void 0, void 0, void 0, function () {
    var parsedOutput, _a, response, errorCode, _b, parsedBody;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
        ...
        switch (_c.label) {
            ...
            case 1:
                ...
                if (data.identity_token_expire_ts !== undefined && data.identity_token_expire_ts !== null) {
                    contents.identityTokenExpireTs = __expectLong(data.identity_token_expire_ts);
                }
                return [2, Promise.resolve(contents)];
        }
    });
...
var deserializeAws_restJson1GlobalEventChatRead = function (output, context) {
    return {
        readTs: __expectLong(output.read_ts),
...
var deserializeAws_restJson1GlobalEventMatchmakerLobbyJoin = function (output, context) {
    return {
        lobby: (output.lobby !== undefined && output.lobby !== null) ? deserializeAws_restJson1MatchmakerLobby(output.lobby, context) : undefined,
    };
};
...
var deserializeAws_restJson1ChatMessage = function (output, context) {
    return {
        ...
        sendTs: __expectLong(output.send_ts),
        threadId: __expectString(output.thread_id),
    };
};
...
var deserializeAws_restJson1ChatThread = function (output, context) {
    return {
        ...
        id: __expectString(output.id),
        lastReadTs: __expectLong(output.last_read_ts),
        ...
        topic: (output.topic !== undefined && output.topic !== null) ? deserializeAws_restJson1ChatTopicContext(__expectUnion(output.topic), context) : undefined,
...
var deserializeAws_restJson1ChatTopicContext = function (output, context) {
    if (output.direct !== undefined && output.direct !== null) {
        return {
            direct: deserializeAws_restJson1ChatTopicDirectContext(output.direct, context)
        };
    }
    if (output.group !== undefined && output.group !== null) {
        return {
            group: deserializeAws_restJson1ChatTopicGroupContext(output.group, context)
        };
    }
    if (output.party !== undefined && output.party !== null) {
        return {
            party: deserializeAws_restJson1ChatTopicPartyContext(output.party, context)
        };
    }
    return { $unknown: Object.entries(output)[0] };
};
var deserializeAws_restJson1ChatTopicDirectContext = function (output, context) {
    return {
...
var deserializeAws_restJson1ChatTopicGroupContext = function (output, context) {
    return {
        group: (output.group !== undefined && output.group !== null) ? deserializeAws_restJson1GroupHandle(output.group, context) : undefined,
    };
};
var deserializeAws_restJson1ChatTopicPartyContext = function (output, context) {
    return {
        party: (output.party !== undefined && output.party !== null) ? deserializeAws_restJson1PartyHandle(output.party, context) : undefined,
    };
};
...
var deserializeAws_restJson1IdentityProfile = function (output, context) {
    return {
        ...
        joinTs: __expectLong(output.join_ts),
...
var deserializeAws_restJson1MatchmakerLobby = function (output, context) {
    return {
        lobbyId: __expectString(output.lobby_id),
        player: (output.player !== undefined && output.player !== null) ? deserializeAws_restJson1MatchmakerLobbyPlayer(output.player, context) : undefined,
        ports: (output.ports !== undefined && output.ports !== null) ? deserializeAws_restJson1MatchmakerLobbyPorts(output.ports, context) : undefined,
        region: (output.region !== undefined && output.region !== null) ? deserializeAws_restJson1MatchmakerLobbyRegion(output.region, context) : undefined,
    };
};
var deserializeAws_restJson1MatchmakerLobbyPlayer = function (output, context) {
    return {
        token: __expectString(output.token),
    };
};
var deserializeAws_restJson1MatchmakerLobbyPort = function (output, context) {
    return {
...
var deserializeAws_restJson1MatchmakerLobbyPorts = function (output, context) {
    return Object.entries(output).reduce(function (acc, _a) {
        ...
        return __assign(__assign({}, acc), (_b = {}, _b[key] = deserializeAws_restJson1MatchmakerLobbyPort(value, context), _b));
    }, {});
};
var deserializeAws_restJson1MatchmakerLobbyRegion = function (output, context) {
    return {
        displayName: __expectString(output.display_name),
