    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                resolvedPath = "".concat((basePath === null || basePath === void 0 ? void 0 : basePath.endsWith('/')) ? basePath.slice(0, -1) : (basePath || '')) + "/entries/batch";
                query = __assign({}, (input.namespaceId !== undefined && { "namespace_id": input.namespaceId }));
                body = JSON.stringify(__assign({}, (input.entries !== undefined && input.entries !== null && { "entries": serializeAws_restJson1PutEntries(input.entries, context) })));
                return [2, new __HttpRequest({
                        protocol: protocol,
                        hostname: hostname,
                        port: port,
...
var serializeAws_restJson1PutBody = function (input, context) {
    return input;
};
...
var deserializeAws_restJson1KvEntry = function (output, context) {
    return {
        ...
        key: (output.key !== undefined && output.key !== null) ? deserializeAws_restJson1SegmentedKey(output.key, context) : undefined,
        value: (output.value !== undefined && output.value !== null) ? deserializeAws_restJson1Document(output.value, context) : undefined,
    };
};
var deserializeAws_restJson1SegmentedKey = function (output, context) {
    var retVal = (output || []).filter(function (e) { return e != null; }).map(function (entry) {
        if (entry === null) {
            return null;
        }
